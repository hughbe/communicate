...
namespace Communicate
{
    public class CommunicationData
    {
        ...
        private void ThrowEncodingException(string type, string name)
        {
            if (type == null)
            {
                throw new ArgumentNullException(nameof(type));
            ...
            throw new ArgumentException("This data type is not supported by Communicate on Windows, or is not" + name + "encodable.", name);
        }
        ...
        public CommunicationData WithEncodedString(string value, EncodedDataType encodedDataType)
        {
            ...
            switch (encodedDataType)
            {
                ...
                case EncodedDataType.Binary:
                    ThrowEncodingException("string", nameof(encodedDataType));
                    break;
                case EncodedDataType.Keyed:
                    ThrowEncodingException("string", nameof(encodedDataType));
                    break;
                default:
                    ThrowEncodingException("string", nameof(encodedDataType));
        ...
        public CommunicationData WithObject(object value, EncodedDataType encodedDataType)
        {
            ...
            switch (encodedDataType)
            {
                ...
                case EncodedDataType.Binary:
                    ...
                    break;
                case EncodedDataType.Keyed:
                    ThrowEncodingException("object", nameof(encodedDataType));
                    break;
                default:
                    ThrowEncodingException("object", nameof(encodedDataType));
                    break;
        ...
        public CommunicationData WithDictionary(IDictionary dictionary, EncodedDataType encodedDataType)
        {
            ...
            switch (encodedDataType)
            {
                ...
                case EncodedDataType.Binary:
                    ...
                    break;
                case EncodedDataType.Keyed:
                    ThrowEncodingException("dictionary", nameof(encodedDataType));
                    break;
                default:
                    ThrowEncodingException("dictionary", nameof(encodedDataType));
                    break;
        ...
        public CommunicationData WithList(IList list, EncodedDataType encodedDataType)
        {
            ...
            switch (encodedDataType)
            {
                ...
                case EncodedDataType.Binary:
                    ...
                    break;
                case EncodedDataType.Keyed:
                    ThrowEncodingException("array", nameof(encodedDataType));
                    break;
                default:
                    ThrowEncodingException("array", nameof(encodedDataType));
                    break;
        ...
        private static int GetLength(ICollection<byte> data) => data?.Count ?? 0;
