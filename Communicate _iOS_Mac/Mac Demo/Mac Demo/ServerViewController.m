...
- (void)viewDidLoad {
    ...
    [TXTRecords addTXTRecordWithKey:"platform" value:"mac"];

    CommunicatorInfo *communicatorInfo = [[CommunicatorInfo alloc]initWithName:@"Mac" port:12345 txtRecordList:TXTRecords];
